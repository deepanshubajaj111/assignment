...
const ShaderMaterial: React.FC<ShaderMaterialProps> = ({
  ...
  // Memoize getUniforms and include as a dependency in useMemo
  ...
  // Add getUniforms to useMemo dependency array
  ...
  }, [size.width, size.height, source, getUniforms]); // <-- getUniforms added
